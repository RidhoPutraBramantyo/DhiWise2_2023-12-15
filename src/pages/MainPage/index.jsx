...
const MainPagePage = () => {
  ...
  const mainPageCardPropList = [
    ...
    },
    {
      ...
      p2pilihantoppingone: "Pepperoni Sapi dan Keju Mozzarella",
    },
    {
    ...
    },
    {
      ...
      p2pilihantoppingone:
        "Keju Mozzarella (String & Shredded) dan Keju Parmesan",
    },
  ];
    ...
    <>
      <div className="bg-gray-50 flex flex-col font-poppins items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <Sidebar className="!sticky !w-28 bg-white-A700 border-blue_gray-100 border-r border-solid flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]">
            <div className="flex flex-col md:gap-10 gap-20 items-center justify-start mt-11 mx-auto w-auto">
              ...
              <div className="flex flex-col gap-8 items-start justify-start w-auto">
                ...
                <div className="flex flex-col items-center justify-start p-4 rounded-[12px] w-[72px]">
                  <Img
                    className="h-10 w-10"
              ...
              <div className="flex flex-col gap-1 items-start justify-start w-full">
                ...
                <div className="flex md:flex-col flex-row gap-3 items-start justify-start py-2 w-full">
                  <div className="bg-gray-50_01 border border-indigo-50 border-solid flex flex-row gap-4 items-center justify-start p-4 rounded-lg w-60">
                    <Button className="!text-red-900 cursor-pointer font-medium min-w-[60px] rounded-lg text-2xl md:text-[22px] text-center sm:text-xl">
                      01
                    </Button>
                  ...
                  <div className="bg-gray-50_01 border border-indigo-50 border-solid flex flex-row gap-4 items-start justify-start p-4 rounded-lg w-[139px]">
                    <Button className="cursor-pointer font-medium min-w-[60px] rounded-lg text-2xl md:text-[22px] text-center sm:text-xl">
                      04
                    </Button>
                    <div className="flex flex-col gap-2 items-start justify-start w-auto">
                      <Text
              ...
              <div className="flex flex-col gap-1 items-start justify-start w-full">
                ...
                >
                  ...
                  <MainPageMenucategories
                    ...
                    bestsellerimage="images/img_ricepasta.png"
                    submenu="Rice & Pasta"
                  />
                  <MainPageMenucategories
                    className="bg-deep_orange-50 flex flex-row gap-1 items-center justify-start pl-2 pr-4 py-1 rounded-[12px] w-auto"
                    bestsellerimage="images/img_appatizer.png"
                    submenu="Appetizer"
                  />
                  <MainPageMenucategories
                    className="bg-deep_orange-50 flex flex-row gap-1 items-center justify-start pl-2 pr-4 py-1 rounded-[12px] w-auto"
                    bestsellerimage="images/img_drinks.png"
                    submenu="Drinks"
                  />
                </List>
              </div>
                ...
                <div className="flex flex-col gap-2 items-start justify-start w-full">
                  ...
                  <div className="flex flex-col gap-2 items-start justify-start w-auto">
                    ...
                    <Button
                      ...
                      leftIcon={
                        <Img
                          className="h-4 mt-px mb-[3px] mr-1"
